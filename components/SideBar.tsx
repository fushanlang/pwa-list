      ...
      <div className="mt-1 mb-2 w-60 text-center">
        <div className="w-full border-t-2">
          <Link href="/add" as="/add">
            <a className="inline-block mt-5 mb-1 px-2 py-1 text-gray-50 bg-green-400 shadow-md rounded-md hover:bg-green-600 hover:shadow-none transition ease-in-out">
